...
st.sidebar.markdown("""
[Use Example Data?](https://raw.githubusercontent.com/dataprofessor/data/master/delaney_solubility_with_descriptors.csv)
""")
...
def build_model(df):
    ...
    grid_pivot = grid_reset.pivot(index='max_features', columns='n_estimators', values='mean_score')
